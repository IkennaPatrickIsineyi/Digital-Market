...
const setupDatabase = require('./controllers/dm.controller.js').setupDatabase;
...
//define dir path
const dir = path.join(__dirname, 'dm-app', 'build');
...
app.get("/*", function (req, res) {
	const indexPagePath = path.join(__dirname, 'dm-app', 'build', 'index.html');
